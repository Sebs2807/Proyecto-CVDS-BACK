 ...
 * Extiende la interfaz {@link MongoRepository} para proporcionar acceso CRUD a los documentos de la colección "libros".
 * Se define un método personalizado para realizar búsquedas con múltiples condiciones.
 * 
 */
@Repository
public interface LibroRepository extends MongoRepository<Libro, String> {
    ...
    /**
     * Busca los libros que coinciden con alguno de los campos: nombre del libro, autor, editor o edición.
     * 
     * Esta consulta utiliza una operación `$or` para combinar las búsquedas por los diferentes campos.
     * Si se proporciona un valor para cualquiera de los parámetros, se devolverán los libros que coincidan con al menos uno de esos valores.
     * 
